	...
	return (
		<>
			{skills.map((item, key) => (
				<div
					key={key}
					className={`h-[120px] w-[140px] bg-white drop-shadow-md rounded-md flex justify-center items-center transition transform hover:scale-110 flex-col hover:border ${item.hover_border} xs:max-md:h-[80px] xs:max-md:w-[80px]`}
				>
					<div
