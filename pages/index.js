			...
			<main className="relative">
				<div className="grid grid-cols-12 relative top-[80px] pt-[90px]">
					...
					<div className="relative h-auto col-start-2 col-span-5 xs:max-lg:order-last xs:max-lg:col-start-2 xs:max-lg:col-span-10 xs:max-lg:top-[100px]">
						<label className="font-bold text-[70px] leading-none pt-[40px] tracking-tight xs:max-lg:block xs:max-lg:text-cente">
							I&apos;m a{" "}
					...
					{/* ==== Image ===== */}
					<div className="col-start-8 pl-[50px] xs:max-lg:col-start-1 xs:max-lg:col-span-12 xs:max-lg:flex items-center justify-center">
						<div
